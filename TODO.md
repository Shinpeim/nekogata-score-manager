...
- ✅ **Phase 2進捗**: インポート/エクスポート(100%完了)、残り：完全永続化テスト、PWA機能
...
- [ ] **E2Eテスト緊急強化** (推定工数: 1-2週間)
  ...
  - [ ] **Phase 2: データ永続化・フロー強化** ✅ **完了 - 手動テストに移行**
    - [x] **インポート・エクスポート機能テスト** - ✅ 実装完了（2025-06-18）
      - [x] エクスポートダイアログの完全UIフロー（チャート選択→ダイアログ表示→ファイル名確認）
      - [x] エラーハンドリング(不正JSON、無効フォーマット、空ファイル)の包括的テスト
      - [x] CSS問題解決によるチェックボックスvisibility問題の根本解決
    - [ ] **テスト品質改善**
...
### 手動テスト項目（詳細手順は MANUAL_TESTING.md を参照）
- [x] **手動テスト手順書作成** ✅ **完了** - [MANUAL_TESTING.md](./MANUAL_TESTING.md) 参照
...
- 📋 **次優先事項**: Phase 2完全永続化テスト、Phase 3 PWA機能テスト
...
- **データ永続化**: ⚠️ 部分的（移調後永続化、インポート・エクスポート完了、完全永続化テスト残り）
