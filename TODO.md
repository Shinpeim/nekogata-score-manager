...
- [ ] 小節線が見えにくいので、色を濃くするなりなんなりで見やすくしたい
- [ ] 小節の改行ごとに余計なマージンが取られているから、そのマージンを無くしたい
- [ ] セクション名は【】で囲んで表示する。また、セクション名のサイズは小さくて良い
- [ ] 初めて画面を開いたときに今は「新規作成」しかないけど、「インポート」「Score Explorerを開く」もボタンを用意しておきたいな
- [ ] コード譜入力画面で、コード進行をコピペできるようにしたいな
- [ ] コード譜入力画面で、セクションを複製できるようにしたい
